        ...
        <div class="col-sm-12">
            <div class="row">
                <div class="col-lg-12 col-md-4 mb-4">
                    <form class="box bg-white" method="POST" enctype="multipart/form-data" id="addSliderForm" action="{{ route('admin.store_slider') }}">
                    @csrf
                        <div class="box-row flex-wrap">
                            ...
                            <div class="col-md-12 mb-3 text-center">
                                <a href="{{ route('admin.list_slider') }}" class="btn light">Cancel</a>
